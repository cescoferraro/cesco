...
export type SitePageFieldsEnum = 
  ...
  | 'context___previous___frontmatter___image'
  | 'context___previous___frontmatter___categorie'
...
export type ClientQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMdx: (
    Pick<MdxConnection, 'totalCount'>
    & { edges: Array<{ node: (
        Pick<Mdx, 'excerpt'>
        & { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'date' | 'name' | 'description' | 'image'>> }
      ) }> }
  ) };
...
export type HomeQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, projects: { edges: Array<{ node: (
        Pick<Mdx, 'fileAbsolutePath' | 'excerpt'>
        & { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'date' | 'title' | 'description' | 'image' | 'categorie'>> }
      ) }> } };

export type NewsQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type NewsQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMdx: (
    Pick<MdxConnection, 'totalCount'>
    & { edges: Array<{ node: (
        Pick<Mdx, 'excerpt'>
...
export type BlogQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMdx: (
    Pick<MdxConnection, 'totalCount'>
    & { edges: Array<{ node: (
        Pick<Mdx, 'excerpt'>
        & { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'date' | 'title' | 'description'>> }
...
export type TeamQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMdx: (
    Pick<MdxConnection, 'totalCount'>
    & { edges: Array<{ node: (
        Pick<Mdx, 'excerpt'>
        & { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'date' | 'name' | 'job' | 'image'>> }
      ) }> }
  ) };
...
export type NewsPostBySlugQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'author'>> }>, mdx?: Maybe<(
...
export type PortifolioPostBySlugQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'author'>> }>, mdx?: Maybe<(
    Pick<Mdx, 'id' | 'excerpt' | 'body'>
    & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'date' | 'description'>> }
  )> };
