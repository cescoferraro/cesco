...
export type AboutQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMdx: (
    Pick<MdxConnection, 'totalCount'>
    & { edges: Array<{ node: (
        Pick<Mdx, 'excerpt'>
        & { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'date' | 'name' | 'job'>> }
      ) }> }
  ) };
...
export type HomeQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, clients: { edges: Array<{ node: (
        Pick<Mdx, 'fileAbsolutePath' | 'excerpt'>
        & { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'name' | 'date' | 'title' | 'description'>> }
      ) }> }, projects: { edges: Array<{ node: (
        Pick<Mdx, 'fileAbsolutePath' | 'excerpt'>
        & { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'date' | 'title' | 'description'>> }
      ) }> }, news: { edges: Array<{ node: (
        Pick<Mdx, 'fileAbsolutePath' | 'excerpt'>
        & { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'name' | 'date' | 'title' | 'description'>> }
      ) }> } };
