    ...
    <Fragment>
        <Hidden smDown>
            <Drawer variant="permanent" anchor="right" classes={{ paper: classes.drawerPaper }}>
              <Container style={{ display: 'flex', alignItems: 'center', transform: 'rotate(-90deg)' }}>
                <ul style={{ color: "#AAA", listStyle: 'none', display: 'flex', justifyContent: 'space-evenly', margin: 16 }}>
