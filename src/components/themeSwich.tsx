...
import { Paper, Switch, Box, SvgIcon } from '@material-ui/core'
...
export default function ThemeSwich() {
  ...
  return (
    <SwitchPaper>
      ...
      <YellowSwitch checked={state.checked} onChange={handleChange} name="checked" />
      <IconBox>
        <svg width="16" height="20">
          <path d="M8.66667 5.83419C8.66667 4.55418 9.21364 3.36099 10.1599 2.50717L11.1449 1.61831L9.82112 1.39343C9.44229 1.32908 9.05645 1.29648 8.66667 1.29648C4.98477 1.29648 2 4.19877 2 7.77892C2 11.3591 4.98477 14.2614 8.66667 14.2614C10.9236 14.2614 12.9895 13.1618 14.2177 11.3699L14.9621 10.2839L13.6224 10.3634C13.5265 10.369 13.4301 10.3719 13.3333 10.3719C10.756 10.3719 8.66667 8.3403 8.66667 5.83419ZM8.66667 12.9649C5.72115 12.9649 3.33333 10.643 3.33333 7.77892C3.33333 5.02253 5.5449 2.7684 8.33676 2.60273C7.69112 3.5449 7.33333 4.66206 7.33333 5.83419C7.33333 8.71175 9.4758 11.1027 12.2943 11.5812C11.3252 12.4562 10.0406 12.9649 8.66667 12.9649Z"
                fill="black"
          />
        </svg>
      </IconBox>
